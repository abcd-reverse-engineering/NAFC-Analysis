...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    */
    ...
    private void updateResourcesConfigurationForNightMode(int i2, boolean z, @Nullable Configuration configuration) throws IllegalAccessException, IllegalArgumentException {
    ...
    */
    ...
    ActionMode startSupportActionModeFromWindow(@NonNull ActionMode.Callback callback) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    final int updateStatusGuard(@Nullable WindowInsetsCompat windowInsetsCompat, @Nullable Rect rect) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        boolean z;
        boolean z2;
