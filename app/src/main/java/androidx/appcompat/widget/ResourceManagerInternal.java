...
public final class ResourceManagerInternal {
    ...
    private Drawable createDrawableIfNeeded(@NonNull Context context, @DrawableRes int i2) throws Resources.NotFoundException {
    ...
    private Drawable loadDrawableFromDelegates(@NonNull Context context, @DrawableRes int i2) throws XmlPullParserException, Resources.NotFoundException, IOException {
        int next;
