...
class TooltipPopup {
    ...
    private void computePosition(View view, int i2, int i3, boolean z, WindowManager.LayoutParams layoutParams) throws Resources.NotFoundException {
        int height;
        int i4;
    ...
    void show(View view, int i2, int i3, boolean z, CharSequence charSequence) throws Resources.NotFoundException {
        if (isShowing()) {
            hide();
        }
