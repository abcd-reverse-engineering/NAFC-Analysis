...
public final class LayoutInflaterCompat {
    ...
    @Deprecated
    public static void setFactory(@NonNull LayoutInflater layoutInflater, @NonNull LayoutInflaterFactory layoutInflaterFactory) throws IllegalAccessException, IllegalArgumentException {
    ...
    public static void setFactory2(@NonNull LayoutInflater layoutInflater, @NonNull LayoutInflater.Factory2 factory2) throws IllegalAccessException, IllegalArgumentException {
