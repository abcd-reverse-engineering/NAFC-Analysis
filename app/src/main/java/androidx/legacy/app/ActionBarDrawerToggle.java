...
public class ActionBarDrawerToggle implements DrawerLayout.DrawerListener {
    ...
    private void setActionBarDescription(int i2) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        Delegate delegate = this.mActivityImpl;
        if (delegate != null) {
    ...
    private void setActionBarUpIndicator(Drawable drawable, int i2) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        Delegate delegate = this.mActivityImpl;
        if (delegate != null) {
    ...
    public void setHomeAsUpIndicator(int i2) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
