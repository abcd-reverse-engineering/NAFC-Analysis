...
class ClassesInfoCache {
    ...
    static class CallbackInfo {
        ...
        private static void invokeMethodsForEvent(List<MethodReference> list, LifecycleOwner lifecycleOwner, Lifecycle.Event event2, Object obj) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            if (list != null) {
        ...
        void invokeCallbacks(LifecycleOwner lifecycleOwner, Lifecycle.Event event2, Object obj) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    static class MethodReference {
        ...
        void invokeCallback(LifecycleOwner lifecycleOwner, Lifecycle.Event event2, Object obj) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            try {
