...
public class SlidingPaneLayout extends ViewGroup {
    ...
    private class DragHelperCallback extends ViewDragHelper.Callback {
        ...
        @Override // androidx.customview.widget.ViewDragHelper.Callback
        public void onViewPositionChanged(View view, int i2, int i3, int i4, int i5) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    private void dimChildView(View view, float f2, int i2) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
        if (f2 > 0.0f && i2 != 0) {
    ...
    */
    ...
    @Override // android.view.ViewGroup, android.view.View
    protected void onLayout(boolean z, int i2, int i3, int i4, int i5) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        int i6;
        int i7;
        int i8;
        int i9;
  ...
  0x00a9: PHI (r12v2 float) = (r12v1 float), (r12v3 float) binds: [B:32:0x00a0, B:34:0x00a5] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    void onPanelDragged(int i2) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
