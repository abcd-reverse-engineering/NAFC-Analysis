...
class ViewOverlayApi14 implements ViewOverlayImpl {
    ...
    static class OverlayViewGroup extends ViewGroup {
        ...
        protected ViewParent invalidateChildInParentFast(int i2, int i3, Rect rect) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
