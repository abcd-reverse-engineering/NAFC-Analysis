...
class d {
    ...
    void a() {
        ...
        while (true) {
            synchronized (this.f1717a) {
                ...
                Map.Entry<String, l.c> entryPollFirstEntry = this.f1717a.pollFirstEntry();
    ...
    private void b(String str, l.e eVar) {
        ConnProtocol connProtocolValueOf = ConnProtocol.valueOf(eVar.f2020b);
        ConnType connTypeValueOf = ConnType.valueOf(connProtocolValueOf);
        if (connTypeValueOf == null) {
            return;
        }
        ALog.i("anet.HorseRaceDetector", "startLongLinkTask", null, Constants.KEY_HOST, str, "ip", eVar.f2019a, "port", Integer.valueOf(eVar.f2020b.f1989a), "protocol", connProtocolValueOf);
        String str2 = "HR" + this.f1718b.getAndIncrement();
    ...
    private void a(String str, l.e eVar) throws JSONException {
        HttpUrl httpUrl = HttpUrl.parse(eVar.f2020b.f1990b + HttpConstant.SCHEME_SPLIT + str + eVar.f2021c);
        if (httpUrl == null) {
            return;
        }
        ALog.i("anet.HorseRaceDetector", "startShortLinkTask", null, "url", httpUrl);
        Request requestBuild = new Request.Builder().setUrl(httpUrl).addHeader("Connection", "close").setConnectTimeout(eVar.f2020b.f1991c).setReadTimeout(eVar.f2020b.f1992d).setRedirectEnable(false).setSslSocketFactory(new anet.channel.util.j(str)).setSeq("HR" + this.f1718b.getAndIncrement()).build();
        requestBuild.setDnsOptimize(eVar.f2019a, eVar.f2020b.f1989a);
        long jCurrentTimeMillis = System.currentTimeMillis();
        ...
        if (i2 <= 0) {
            ...
            horseRaceStat.reqErrorCode = aVarA.f1883a;
