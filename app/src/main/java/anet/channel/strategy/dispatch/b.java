...
class b {
        ...
        for (int i2 = 0; i2 < 3; i2++) {
            ...
            if (i2 != 2) {
                ...
                if (amdcServerFixIp != null && amdcServerFixIp.length > 0) {
                    strA = a(schemeByHost, amdcServerFixIp[f1972c.nextInt(amdcServerFixIp.length)], 0, map2, i2);
                } else {
    ...
    /* JADX WARN: Removed duplicated region for block: B:128:0x02bb A[Catch: all -> 0x02db, TryCatch #13 {all -> 0x02db, blocks: (B:126:0x02b1, B:128:0x02bb, B:129:0x02bf), top: B:168:0x02b1 }] */
    /* JADX WARN: Removed duplicated region for block: B:157:0x02ce A[EXC_TOP_SPLITTER, SYNTHETIC] */
