...
public class SignatureCheck {
    public static String getMD5Signature(Context context, String str) throws PackageManager.NameNotFoundException {
    ...
    private static Signature[] getRawSignature(Context context, String str) throws PackageManager.NameNotFoundException {
