...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    private ColorStateList createDefaultColorStateList(int i2) throws Resources.NotFoundException {
    ...
    public NavigationView(Context context, AttributeSet attributeSet, int i2) throws Resources.NotFoundException {
