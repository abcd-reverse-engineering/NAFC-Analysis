...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    public static class Builder {
        ...
        public Builder setDataForContentValuesHashMap(HashMap<String, Object> map) {
            ...
            if (str == null || (obj = map.get(str)) == null) {
                ...
                Integer num = this.f6719d.get(obj);
                if (num != null) {
                    iIntValue = num.intValue();
                    z = true;
                } else {
                    this.f6719d.put(obj, Integer.valueOf(this.f6717b.size()));
                    z = false;
                }
            }
            if (z) {
                this.f6717b.remove(iIntValue);
                this.f6717b.add(iIntValue, map);
            } else {
                this.f6717b.add(map);
            }
            return this;
    ...
    private static ArrayList<CursorWindow> iterCursorWindow(Builder builder, int i2, List list) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            try {
                ...
                zPutValue = true;
                for (int i4 = 0; i4 < builder.f6716a.length && (zPutValue = putValue(cursorWindow3, map.get(builder.f6716a[i4]), i3, i4)); i4++) {
                }
    ...
    */
    ...
    private static CursorWindow[] getCursorWindows(Builder builder, int i2) {
        ...
        ArrayList<CursorWindow> arrayListIterCursorWindow = iterCursorWindow(builder, i2, builder.f6717b.subList(0, i2));
