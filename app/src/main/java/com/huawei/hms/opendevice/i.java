...
public class i extends PushPreferences {
    ...
    private static final String f7135c = "i";
    ...
    public String b(String str) {
        try {
            ...
            HMSLog.e(f7135c, "getSecureData" + e2.getMessage());
            return "";
        }
    }
    ...
    public boolean c(String str) {
        try {
            ...
            HMSLog.e(f7135c, "removeToken" + e2.getMessage());
            return false;
        }
    }
    ...
    public String a(String str) {
        ...
        try {
            return PushEncrypter.decrypter(this.f7136b, getString(str));
        } catch (Exception e2) {
            HMSLog.e(f7135c, "getSecureData" + e2.getMessage());
            return "";
        }
    ...
    public boolean a(String str, String str2) {
        ...
        try {
            return saveString(str, PushEncrypter.encrypter(this.f7136b, str2));
        } catch (Exception e2) {
            HMSLog.e(f7135c, "saveSecureData" + e2.getMessage());
            return false;
        }
    }
