...
public class t {
    ...
    private static void a(Context context, Intent intent, byte[] bArr, byte[] bArr2) throws URISyntaxException {
    ...
    private static void a(Context context, Intent intent, String str, o oVar, int i2) throws URISyntaxException {
