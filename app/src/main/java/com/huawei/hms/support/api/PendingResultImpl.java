...
public abstract class PendingResultImpl<R extends Result, T extends IMessageEntity> extends InnerPendingResult<R> {
    ...
    public void a(int i2, IMessageEntity iMessageEntity) {
        ...
        if (i2 == 0) {
            this.f7265b = (R) onComplete(iMessageEntity);
        } else {
            this.f7265b = (R) onError(i2);
        }
        if (this.f7269f) {
            a(i2, 2);
        }
        ...
        if (apiClient != null && this.f7267d != null && !HiAnalyticsUtil.getInstance().hasError(apiClient.getContext())) {
            ...
            if (i3 == 1) {
                ...
                if (r != null && r.getStatus() != null) {
                    map.put(HiAnalyticsConstant.HaKey.BI_KEY_RESULT, String.valueOf(this.f7265b.getStatus().getStatusCode()));
                }
            }
            map.put("version", "0");
            ...
            if (TextUtils.isEmpty(this.f7268e)) {
                ...
                map.put(HiAnalyticsConstant.HaKey.BI_KEY_TRANSID, this.f7268e);
                this.f7268e = null;
            }
            String[] strArrSplit = this.f7267d.split("\\.");
