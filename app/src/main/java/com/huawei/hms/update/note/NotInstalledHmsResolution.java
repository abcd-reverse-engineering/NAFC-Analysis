...
public class NotInstalledHmsResolution implements IBridgeActivityDelegate {
    ...
    private void a(Activity activity) {
        a();
        this.f7336a = NotInstalledHmsDialogHelper.getDialogBuilder(activity).setPositiveButton(NotInstalledHmsDialogHelper.getConfirmResId(activity), new a(activity)).show();
    }
