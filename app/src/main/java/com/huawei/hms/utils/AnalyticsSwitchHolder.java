...
public class AnalyticsSwitchHolder {
    ...
    private static volatile int f7351a;

    /* renamed from: b, reason: collision with root package name */
    private static final Object f7352b = new Object();

    /* renamed from: c, reason: collision with root package name */
    private static volatile Long f7353c = 0L;

    /* renamed from: d, reason: collision with root package name */
    private static volatile boolean f7354d = false;

    /* renamed from: e, reason: collision with root package name */
    private static volatile boolean f7355e = false;
    ...
    class a implements Runnable {
        ...
        public void run() {
            AnalyticsSwitchHolder.f(this.f7356a);
    ...
    class b implements Runnable {
        ...
        public void run() {
            ...
            AnalyticsSwitchHolder.f(this.f7357a);
    ...
    private static void c(Context context) {
        f7353c = Long.valueOf(new Timestamp(System.currentTimeMillis()).getTime());
    ...
    private static void e(Context context) {
        ...
        if (timestamp.getTime() - f7353c.longValue() < 86400000 || f7353c.longValue() <= 0) {
            return;
        }
        f7353c = Long.valueOf(timestamp.getTime());
    ...
    public static void f(Context context) {
        ...
        if (HiAnalyticsUtils.getInstance().getInitFlag() || f7354d) {
            return;
        }
