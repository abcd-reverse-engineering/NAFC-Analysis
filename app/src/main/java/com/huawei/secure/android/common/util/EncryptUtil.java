...
public class EncryptUtil {
    ...
    public static byte[] generateSecureRandom(int i2) throws NoSuchAlgorithmException {
        ...
        try {
            ...
            LogsUtil.e(f7679a, "getSecureRandomBytes: NoSuchAlgorithmException");
        }
        ...
        if (instanceStrong == null) {
            try {
                ...
                LogsUtil.e(f7679a, "getSecureRandomBytes getInstance: NoSuchAlgorithmException");
                return new byte[0];
            } catch (Exception e2) {
                LogsUtil.e(f7679a, "getSecureRandomBytes getInstance: exception : " + e2.getMessage());
                return new byte[0];
            }
        }
