...
public class a extends SQLiteOpenHelper {
    ...
    private synchronized boolean a(String str, String str2, boolean z, String str3) {
        ...
        try {
            ...
            cursorQuery = writableDatabase.query(d.F, new String[]{bl.f10170d, "date", Constants.KEY_HOST, "serviceid", "bid", "isbackground", "size"}, "date=? AND host=? AND bid=? AND isbackground=?", new String[]{str3, str, str2, String.valueOf(z)}, null, null, null, String.valueOf(100));
            if (cursorQuery != null) {
    ...
    public List<TrafficsMonitor.a> a(boolean z) {
        ...
        synchronized (this) {
            ...
            try {
                ...
                if (z) {
                    cursorQuery = writableDatabase.query(d.F, new String[]{bl.f10170d, "date", Constants.KEY_HOST, "serviceid", "bid", "isbackground", "size"}, "date=?", new String[]{UtilityImpl.a(System.currentTimeMillis())}, null, null, null, String.valueOf(100));
                } else {
                    cursorQuery = writableDatabase.query(d.F, new String[]{bl.f10170d, "date", Constants.KEY_HOST, "serviceid", "bid", "isbackground", "size"}, null, null, null, null, null, String.valueOf(100));
                }
                if (cursorQuery == null) {
                    if (cursorQuery != null) {
                        cursorQuery.close();
