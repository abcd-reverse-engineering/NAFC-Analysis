...
public class ServiceImpl extends d {
    ...
    private void b(Intent intent) {
        ...
        com.taobao.accs.net.a aVarB = d.b(this.f8487c, stringExtra5, true);
        if (aVarB == null) {
        ...
        if (intExtra == 1) {
            ...
            Message messageBuildBindApp = Message.buildBindApp(this.f8487c, stringExtra5, stringExtra4, intent.getStringExtra("app_sercet"), stringExtra, stringExtra6, intent.getStringExtra("appVersion"));
            aVarB.f8500a = stringExtra6;
            ...
            if (byteArrayExtra != null) {
                ...
                if (reqType2 == null) {
                    messageBuildRequest = Message.buildSendData(aVarB.b((String) null), stringExtra5, aVarB.f8508i.getStoreId(), this.f8487c, stringExtra, accsRequest, false);
                } else if (reqType2 == Message.ReqType.REQ) {
                    messageBuildRequest = Message.buildRequest(this.f8487c, aVarB.b((String) null), stringExtra5, aVarB.f8508i.getStoreId(), stringExtra, Constants.TARGET_SERVICE_PRE, accsRequest, false);
                }
    ...
    private void a() {
        ...
        long jK = UtilityImpl.k(this.f8487c);
    ...
    private void a(Intent intent, String str) {
        ...
        try {
            ...
            if (TextUtils.equals(str, "android.net.conn.CONNECTIVITY_CHANGE")) {
                String strH = UtilityImpl.h(this.f8487c);
                boolean zI = UtilityImpl.i(this.f8487c);
                ALog.i("ServiceImpl", "network change:" + this.f8489e + " to " + strH, new Object[0]);
                if (zI) {
                    this.f8489e = strH;
                    c();
                    a(true, false);
