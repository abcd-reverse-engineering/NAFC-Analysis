...
public class NetPerformanceMonitor extends BaseMonitor {
    ...
    public boolean beforeCommit() {
        if (this.real_to_bz_date == 0) {
            this.real_to_bz_date = this.f8615d;
        }
        this.accs_sdk_version = 221;
        this.total_time = a(this.f8612a, this.real_to_bz_date);
        this.start_to_enter_queue_time = a(this.f8612a, this.f8613b);
        this.in_queue_time = a(this.f8613b, this.take_date);
        this.talk_to_send_time = a(this.take_date, this.to_tnet_date);
        this.send_to_receive_time = a(this.to_tnet_date, this.f8614c);
        this.receive_to_distribute_time = a(this.f8614c, this.f8615d);
        this.distribute_to_service_time = a(this.f8615d, this.start_service);
        ...
        this.receive_accs_to_call_time = a(this.f8616e, this.f8617f);
        this.receive_agoo_to_call_time = a(this.f8616e, this.f8618g);
    ...
    public void onEnterQueueData() {
        this.f8613b = System.currentTimeMillis();
    }
    ...
    public void onToAccsTime() {
        this.f8617f = System.currentTimeMillis();
    }

    public void onToAgooTime() {
        this.f8618g = System.currentTimeMillis();
    }

    public void onToBizDate() {
        this.f8615d = System.currentTimeMillis();
    }
