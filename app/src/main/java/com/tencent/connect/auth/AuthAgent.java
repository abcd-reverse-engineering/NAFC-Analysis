...
public class AuthAgent extends BaseApi {
    ...
    private class c extends DefaultUiListener {
        ...
        @Override // com.tencent.tauth.DefaultUiListener, com.tencent.tauth.IUiListener
        public void onComplete(Object obj) throws JSONException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    public int doLogin(Activity activity, String str, IUiListener iUiListener, boolean z, Fragment fragment, boolean z2, Map<String, Object> map) {
        ...
        boolean zB = i.a(activity, this.f9634c.getAppId()).b("C_LoginWeb");
    ...
    private int a(boolean z, IUiListener iUiListener, boolean z2, Map<String, Object> map) {
        ...
        bundleA.putString(Constants.PARAM_SCOPE, this.f9506d);
        bundleA.putString(Constants.PARAM_CLIENT_ID, this.f9634c.getAppId());
        if (BaseApi.isOEM) {
            ...
            public void run() {
                ...
                activity.runOnUiThread(new Runnable() { // from class: com.tencent.connect.auth.AuthAgent.1.1
                    ...
                    public void run() {
                        ...
                        TDialog tDialog = new TDialog(activity3, "", strA, cVar, ((BaseApi) AuthAgent.this).f9634c);
                        if (activity.isFinishing()) {
                            return;
                        }
                        tDialog.show();
    ...
    protected void b(IUiListener iUiListener) {
        ...
        HttpUtils.requestAsync(this.f9634c, g.a(), "https://openmobile.qq.com/v3/user/get_info", bundleA, "GET", new BaseApi.TempRequestListener(new a(iUiListener)));
    }
    ...
    private class b extends DefaultUiListener {
        ...
        private void a(String str, final IUiListener iUiListener, final Object obj) throws PackageManager.NameNotFoundException {
        ...
        */
        public void onComplete(java.lang.Object r8) throws org.json.JSONException, android.content.pm.PackageManager.NameNotFoundException {
            /*
                r7 = this;
        ...
        private Drawable a(String str, Context context) throws IOException {
        ...
        protected void a() {
            ...
            HttpUtils.requestAsync(((BaseApi) AuthAgent.this).f9634c, activity, "https://appsupport.qq.com/cgi-bin/qzapps/mapp_addapp.cgi", bundleB, "POST", null);
        }
    }
    ...
    private boolean a(Activity activity, Fragment fragment, Map<String, Object> map, boolean z, Object[] objArr) {
        ...
        if (intentC != null) {
            ...
            intentC.putExtra("appid", this.f9634c.getAppId());
    ...
    protected void a(IUiListener iUiListener) throws NoSuchAlgorithmException {
        String strG;
        ...
        HttpUtils.requestAsync(this.f9634c, g.a(), "https://openmobile.qq.com/user/user_login_statis", bundleA, "POST", null);
