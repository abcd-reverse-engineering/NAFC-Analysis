...
public class SocialOperation extends BaseApi {
    ...
    public void bindQQGroup(final Activity activity, String str, String str2, final IUiListener iUiListener) {
        ...
        HttpUtils.requestAsync(this.f9634c, activity, "https://openmobile.qq.com/cgi-bin/qunopensdk/check_group", bundleA, "GET", new BaseApi.TempRequestListener(defaultUiListener));
    ...
    public void unBindGroup(Context context, String str, final IUiListener iUiListener) {
        ...
        bundleA.putString("appid", appId);
        bundleA.putString("orgid", str);
        HttpUtils.requestAsync(this.f9634c, context, "https://openmobile.qq.com/cgi-bin/qunopensdk/unbind", bundleA, "GET", new BaseApi.TempRequestListener(defaultUiListener));
