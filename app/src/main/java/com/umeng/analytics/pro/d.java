...
public class d {
    ...
    public static final String f10304a = "appkey";
    ...
    public static final String f10305b = "channel";

    /* renamed from: c, reason: collision with root package name */
    public static final String f10306c = "secret";

    /* renamed from: d, reason: collision with root package name */
    public static final String f10307d = "app_version";

    /* renamed from: e, reason: collision with root package name */
    public static final String f10308e = "version_code";

    /* renamed from: f, reason: collision with root package name */
    public static final String f10309f = "wrapper_type";

    /* renamed from: g, reason: collision with root package name */
    public static final String f10310g = "wrapper_version";

    /* renamed from: h, reason: collision with root package name */
    public static final String f10311h = "sdk_version";

    /* renamed from: i, reason: collision with root package name */
    public static final String f10312i = "vertical_type";

    /* renamed from: j, reason: collision with root package name */
    public static final String f10313j = "device_id";

    /* renamed from: k, reason: collision with root package name */
    public static final String f10314k = "device_model";

    /* renamed from: l, reason: collision with root package name */
    public static final String f10315l = "$pr_ve";

    /* renamed from: m, reason: collision with root package name */
    public static final String f10316m = "$ud_da";
    ...
    public static final String al = at.b().b(at.t);
    public static final String am = at.b().b(at.u);
    ...
    public static final String[] aH = {as, at, "_$!du", "_$!c", Y, "_$!sp", "event_name", "token", "time", "ip", bh.O, "region", UserInfo.CITY, "browser", "os", bh.F, "device_version", bh.ai, "screen_width", "screen_height", "referrer", "referrer_domain", "initial_referrer", "initial_referrer_domain", "initial_view_time", "search_engine", "keyword", "ali_lib", "utm_source", "utm_medium", "utm_term", "utm_content", "utm_campaign", "date", "hour", "minute", "app_version", "sp"};
}
