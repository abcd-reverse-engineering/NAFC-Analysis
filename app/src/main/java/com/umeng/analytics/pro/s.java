...
public class s {
        ...
        try {
            if (a(str) && b(str2)) {
                ...
                if (UMUtils.isMainProgress(f10507g)) {
                    strA = y.a().d(UMGlobalContext.getAppContext(f10507g));
                } else {
                    strA = y.a().a(UMGlobalContext.getAppContext(f10507g), jCurrentTimeMillis);
                }
        ...
        try {
            ...
            if (b(map)) {
                ...
                if (UMUtils.isMainProgress(f10507g)) {
                    ...
                    strA = y.a().a(UMGlobalContext.getAppContext(f10507g), jSONObject.getLong("ts"));
                }
                if (TextUtils.isEmpty(strA)) {
                    strA = f10506f;
                }
    ...
    public void a(String str, Map<String, Object> map, String str2) {
        try {
            if (a(str)) {
                ...
                String strD = y.a().d(UMGlobalContext.getAppContext(f10507g));
    ...
    private void a() throws JSONException {
        try {
            String strImprintProperty = UMEnvelopeBuild.imprintProperty(f10507g, "track_list", "");
            ...
            if (this.f10512h != null) {
                for (String str : strArrSplit) {
                    ...
                    if (this.f10512h.has(strSubStr)) {
                        jSONObject.put(strSubStr, this.f10512h.get(strSubStr));
                    }
                }
            }
