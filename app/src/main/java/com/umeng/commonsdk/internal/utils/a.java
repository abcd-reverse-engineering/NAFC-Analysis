...
public class a {
    ...
    private static String e(Context context, String str) throws PackageManager.NameNotFoundException {
        if (context == null) {
            return null;
        }
        try {
    ...
    public static String d() throws NoSuchMethodException, SecurityException {
        try {
