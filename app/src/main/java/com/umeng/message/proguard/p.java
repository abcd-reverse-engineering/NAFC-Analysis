...
public final class p {
    ...
    class c implements Handler.Callback {
        ...
        c() {
            ...
            this.f11403f = new File(applicationA.getFilesDir(), ".upush_log");
            this.f11404g = f.a(applicationA);
            int iLastIndexOf = this.f11404g.lastIndexOf(Constants.COLON_SEPARATOR);
            if (iLastIndexOf < 0) {
                this.f11404g = "";
                return;
            }
            this.f11404g = this.f11404g.substring(iLastIndexOf + 1) + c.c.a.b.a.a.s1;
        }
        ...
        public final boolean handleMessage(Message message) {
            ...
            if (i2 != 1) {
                ...
                if (Math.abs(jCurrentTimeMillis - this.f11399b) > 86400000) {
                    this.f11399b = jCurrentTimeMillis;
                    File[] fileArrListFiles = this.f11403f.listFiles();
            ...
            try {
                ...
                String str = String.format("%s%s", this.f11404g, this.f11401d.format(Long.valueOf(aVar.f11390c)));
                String str2 = String.format("%s %s-%s %s %s %s", this.f11402e.format(Long.valueOf(aVar.f11390c)), Integer.valueOf(aVar.f11392e), Long.valueOf(aVar.f11393f), aVar.f11391d == 3 ? "D" : aVar.f11391d == 4 ? "I" : aVar.f11391d == 5 ? ExifInterface.LONGITUDE_WEST : aVar.f11391d == 6 ? ExifInterface.LONGITUDE_EAST : "U", aVar.f11388a, aVar.f11389b);
                File file2 = new File(this.f11403f, str + ".log");
                if (file2.exists() && file2.length() + str2.length() > 5242880) {
                    File file3 = new File(this.f11403f, str + ".bak");
                    if (file3.exists()) {
                        file3.delete();
                    }
