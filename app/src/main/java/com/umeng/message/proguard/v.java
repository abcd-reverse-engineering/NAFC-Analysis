            ...
            switch (i2) {
                ...
                case InputDeviceCompat.SOURCE_STYLUS /* 16386 */:
                    ...
                    if (jSONObjectOptJSONObject3 != null && jSONObjectOptJSONObject4 != null && (jSONObjectBuildEnvelopeWithExtHeader2 = UMEnvelopeBuild.buildEnvelopeWithExtHeader(applicationA2, jSONObjectOptJSONObject3, jSONObjectOptJSONObject4, "umpx_push_launch", bh.aA, MsgConstant.SDK_VERSION)) != null && !jSONObjectBuildEnvelopeWithExtHeader2.has("exception")) {
                        ...
                        try {
                            ...
                            if (i3 > 0) {
                                messageSharedPrefs.f11128b.a("launch_send_policy", i3);
                            }
                        ...
                        try {
                            ...
                            if (i4 > 0) {
                                messageSharedPrefs.f11128b.a("tag_send_policy", i4);
                            }
                ...
                case 16387:
                    ...
                    if (jSONObjectOptJSONObject5 != null && jSONObjectOptJSONObject6 != null && (jSONObjectBuildEnvelopeWithExtHeader3 = UMEnvelopeBuild.buildEnvelopeWithExtHeader(applicationA3, jSONObjectOptJSONObject5, jSONObjectOptJSONObject6, "umpx_push_register", bh.aA, MsgConstant.SDK_VERSION)) != null && !jSONObjectBuildEnvelopeWithExtHeader3.has("exception")) {
                        MessageSharedPrefs.getInstance(applicationA3).f11128b.a("has_register", true);
                    }
                    y.f11462b = false;
                    break;
                case 16388:
