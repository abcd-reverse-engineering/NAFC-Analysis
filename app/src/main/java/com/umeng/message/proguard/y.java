...
public final class y extends UTrack {
        ...
        b.b(new Runnable() { // from class: com.umeng.message.proguard.y.4
            ...
            public final void run() {
                ...
                try {
                    ...
                    y.this.f11464d.a(str, str2, jSONObjectD, uPushAliasCallback);
                } catch (Throwable th) {
                    UPLog.e("Track", th);
        ...
        b.b(new Runnable() { // from class: com.umeng.message.proguard.y.6
            ...
            public final void run() {
                ...
                try {
                    ...
                    y.this.f11464d.c(str, str2, jSONObjectD, uPushAliasCallback);
                } catch (Throwable th2) {
                    UPLog.e("Track", th2);
        ...
        b.b(new Runnable() { // from class: com.umeng.message.proguard.y.5
            ...
            public final void run() {
                ...
                try {
                    ...
                    y.this.f11464d.b(str, str2, jSONObjectD, uPushAliasCallback);
                } catch (Throwable th2) {
                    UPLog.e("Track", th2);
                    if (th2.getMessage() == null) {
    ...
    public final void trackMsgRepost(UMessage uMessage, Notification notification) {
        ...
        int i2 = acVarA.f11225d;
        String channelId = null;
        try {
            if (Build.VERSION.SDK_INT >= 26 && notification != null) {
                channelId = notification.getChannelId();
            }
            this.f11464d.a(uMessage.getMsgId(), channelId, i2);
        } catch (Throwable th) {
            UPLog.e("Track", th);
        }
    }
    ...
    public final void trackMsgShow(UMessage uMessage, Notification notification) {
        ...
        try {
            ...
            this.f11464d.a(uMessage.getMsgId(), i2, channelId);
        } catch (Throwable th) {
    ...
    final synchronized void b() {
        ...
        try {
            ...
            if (Math.abs(jCurrentTimeMillis - this.f11465e) >= 30000) {
                this.f11465e = jCurrentTimeMillis;
                if (f.b(applicationA)) {
                    ao aoVarA = ao.a(applicationA);
                    Cursor cursorQuery = aoVarA.f11292a.getContentResolver().query(h.d(aoVarA.f11292a), null, null, null, "Time Asc ");
                    if (cursorQuery == null) {
                        arrayList = null;
                    } else {
