...
public abstract class UMSSOHandler {
    ...
    public Uri getImageContentUri(File file) {
        ...
        Cursor cursorQuery = applicationContext.getContentResolver().query(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, new String[]{bl.f10170d}, "_data=? ", new String[]{absolutePath}, null);
