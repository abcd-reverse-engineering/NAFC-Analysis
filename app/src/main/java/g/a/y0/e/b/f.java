...
public final class f<T> extends g.a.y0.e.b.a<T, Boolean> {

    /* renamed from: c, reason: collision with root package name */
    final g.a.x0.r<? super T> f14210c;
    ...
    public f(g.a.l<T> lVar, g.a.x0.r<? super T> rVar) {
        super(lVar);
        this.f14210c = rVar;
    }
    ...
    protected void d(i.d.c<? super Boolean> cVar) {
        this.f14110b.a((g.a.q) new a(cVar, this.f14210c));
    }
}
