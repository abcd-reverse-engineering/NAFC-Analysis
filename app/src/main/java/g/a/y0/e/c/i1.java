...
public final class i1<T, U> extends g.a.y0.e.c.a<T, T> {
    ...
    final i.d.b<U> f14820b;

    /* renamed from: c, reason: collision with root package name */
    final g.a.y<? extends T> f14821c;
    ...
    public i1(g.a.y<T> yVar, i.d.b<U> bVar, g.a.y<? extends T> yVar2) {
        super(yVar);
        this.f14820b = bVar;
        this.f14821c = yVar2;
    }
    ...
    protected void b(g.a.v<? super T> vVar) {
        b bVar = new b(vVar, this.f14821c);
        vVar.onSubscribe(bVar);
        this.f14820b.subscribe(bVar.other);
        this.f14742a.a(bVar);
    }
}
