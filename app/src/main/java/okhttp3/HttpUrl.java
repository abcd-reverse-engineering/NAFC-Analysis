        ...
        Builder parse(@Nullable HttpUrl httpUrl, String str) {
            ...
            if (iSlashCount >= 2 || httpUrl == null || !httpUrl.scheme.equals(this.scheme)) {
                ...
                if (i4 < iDelimiterOffset) {
                    ...
                    if (this.port == -1) {
                        throw new IllegalArgumentException("Invalid URL port: \"" + str.substring(i4, iDelimiterOffset) + h0.f16704a);
                    }
                } else {
                    this.host = canonicalizeHost(str, i3, iPortColonOffset);
                ...
                if (this.host == null) {
                    throw new IllegalArgumentException("Invalid URL host: \"" + str.substring(i3, iPortColonOffset) + h0.f16704a);
                }
