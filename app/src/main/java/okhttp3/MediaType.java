    ...
    public static MediaType get(String str) {
        ...
        for (int iEnd = matcher.end(); iEnd < str.length(); iEnd = matcher2.end()) {
            ...
            if (!matcher2.lookingAt()) {
                throw new IllegalArgumentException("Parameter is not formatted correctly: \"" + str.substring(iEnd) + "\" for: \"" + str + h0.f16704a);
            }
            ...
            if (strGroup != null && strGroup.equalsIgnoreCase("charset")) {
                ...
                if (str2 != null && !strGroup2.equalsIgnoreCase(str2)) {
                    throw new IllegalArgumentException("Multiple charsets defined: \"" + str2 + "\" and: \"" + strGroup2 + "\" for: \"" + str + h0.f16704a);
                }
                str2 = strGroup2;
            }
        }
