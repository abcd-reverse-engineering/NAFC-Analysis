...
public interface BufferedSource extends Source, ReadableByteChannel {
    ...
    long indexOf(@i.c.a.d ByteString byteString) throws IOException;

    long indexOf(@i.c.a.d ByteString byteString, long j2) throws IOException;

    long indexOfElement(@i.c.a.d ByteString byteString) throws IOException;

    long indexOfElement(@i.c.a.d ByteString byteString, long j2) throws IOException;
    ...
    boolean rangeEquals(long j2, @i.c.a.d ByteString byteString) throws IOException;

    boolean rangeEquals(long j2, @i.c.a.d ByteString byteString, int i2, int i3) throws IOException;

    int read(@i.c.a.d byte[] bArr) throws IOException;

    int read(@i.c.a.d byte[] bArr, int i2, int i3) throws IOException;

    long readAll(@i.c.a.d Sink sink) throws IOException;
    ...
    void readFully(@i.c.a.d Buffer buffer, long j2) throws IOException;
    ...
    @i.c.a.d
    String readString(long j2, @i.c.a.d Charset charset) throws IOException;

    @i.c.a.d
    String readString(@i.c.a.d Charset charset) throws IOException;
    ...
    int select(@i.c.a.d Options options) throws IOException;
