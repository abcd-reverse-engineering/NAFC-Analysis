...
public class Config {
    ...
    public static String a(Context context) {
        String string = f17311b;
        if (!TextUtils.isEmpty(string)) {
            return string;
        }
        try {
            string = context.getSharedPreferences(PREFERENCES, 4).getString(PROPERTY_APP_KEY, f17311b);
        } catch (Throwable th) {
    ...
    public static String b(Context context) {
        String string = f17312c;
        if (!TextUtils.isEmpty(string)) {
            return string;
        }
        try {
            string = context.getSharedPreferences(PREFERENCES, 4).getString(PROPERTY_SECRET_KEY, f17312c);
        } catch (Throwable th) {
    ...
    public static String g(Context context) {
        String string = f17313d;
        try {
            string = context.getSharedPreferences(PREFERENCES, 4).getString("deviceId", f17313d);
        } catch (Throwable th) {
    ...
    public static void a(Context context, String str) {
        ...
        if (!TextUtils.isEmpty(f17312c)) {
            ...
            f17312c = str;
            SharedPreferences.Editor editorEdit = context.getSharedPreferences(PREFERENCES, 4).edit();
            editorEdit.putString(PROPERTY_SECRET_KEY, f17312c);
            editorEdit.apply();
